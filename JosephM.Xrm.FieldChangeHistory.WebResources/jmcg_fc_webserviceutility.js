...
FieldChangeServiceUtility = function () {
    var that = this;
            ...
            if (asyncCallback != null) {
                var processResponseData = function (data) {
                    ...
                    for (var i = 0; i < fieldNodes.length; i++) {
                        ...
                        thisField.Createable = true;
                        var createableNode = XrmElementsByTagName(fieldNode, 'IsValidForCreate');
                        if (createableNode.length > 0)
                            thisField.Createable = XrmInnerText(createableNode[0]) != "false";
    ...
    this.FilterCondition = function (field, operator, value, type) {
        ...
        this.value = value;
        this.type = type != null ? type : that.FieldType.String;
    };
...
fieldChangeServiceUtility = new FieldChangeServiceUtility();